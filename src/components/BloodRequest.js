                ...
                <TouchableOpacity onPress={this.props.onClick}>
                    <View style={ style.cardContainer }>
                        <View style={ style.bloodBall }>
                            <Text style={ style.bloodBallText }>{ BloodRequestHelper.handleBloodType(this.props.bloodType) }</Text>
                        </View>
                        <View style={{justifyContent: 'center', paddingLeft: 10}}>
                            <Text style={ style.containerPrimaryText }> { this.props.hemocentro } </Text>
                            <Text style={ style.containerSecondaryText }> { this.props.address } </Text>
